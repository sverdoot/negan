...
from torch_mimicry.training import scheduler, logger, metric_log, Trainer
...
class CustomTrainer(Trainer):
    def __init__(self, 
        ...
        super().__init__(netD, netG, optD, optG, dataloader, num_steps, log_dir, n_dis, lr_decay, device, netG_ckpt_file, netD_ckpt_file, print_steps, vis_steps, log_steps, save_steps, flush_secs)
        ...
        try:
            ...
            while global_step < self.num_steps:
                ...
                for callback in self.callbacks:
                    callback.invoke({'step': global_step})
